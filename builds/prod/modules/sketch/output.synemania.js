    ...
    *
    ...
    NeutralParticle = (function(_super) {
      ...
      NeutralParticle.prototype.move = function() {
        ...
        this.ctx.fillStyle = 'rgba(' + emojs.engine.core.helpers.hexToR(col16) + ',' + emojs.engine.core.helpers.hexToG(col16) + ',' + emojs.engine.core.helpers.hexToB(col16) + ',0.2)';
    ...
    HappyParticle = (function(_super) {
      ...
      HappyParticle.prototype.move = function() {
        ...
        if ((this.color != null)) {
          ...
          this.count += 1;
          this.ctx.fillStyle = 'rgba(' + emojs.engine.core.helpers.hexToR(col16) + ',' + emojs.engine.core.helpers.hexToG(col16) + ',' + emojs.engine.core.helpers.hexToB(col16) + ',' + (50 / this.count) + ')';
          this.ctx.fillRect(this.x, this.y - 1, 1, 1);
